...
extern void StretchSprite32(u32 spriteMap, u32 screen, s32 x1, s32 x2, s32 y1, s32 y2, s32 yr, s32 yw)  __attribute__ ((section (".iwram")));
extern u32 PrjTable[];

void Stretch32(u8 *spriteMap, u8 *screen, s32 x1, s32 x2, s32 y1, s32 y2, s32 yr, s32 yw)
{
	s32 dx, dy, e, d, dx2;
	s32 sx, sy;
	u8 color;
...
void RectStretch32( polygon_type *poly, u16 *screen )
{
	...
	for (d=0; d<=dx; d++)
	{
		//if (yd1>150)
		//	return;
		StretchSprite32(tmap, screen, xd1, xd2, xs1, xs2, ys1, yd1);
